...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<Object>> handleNoDataFoundException(NoDataFoundException ex, WebRequest request) {
        ...
        String debugMessage = "Request URI: " + request.getDescription(false) + "\n" +
    ...
    public ResponseEntity<ApiResponse<Object>> handleEmailAlreadyException(EmailAlreadyException ex, WebRequest request) {
        String message = ex.getMessage();
        if (message == null || message.isEmpty()) {
    ...
    public ResponseEntity<ApiResponse<Object>> handleGeneralException(Exception ex, WebRequest request) {
        ...
        PrintWriter pw = new PrintWriter(sw);
        ex.printStackTrace(pw);
        String debugMessage = "Unexpected error: " + ex.getClass().getName() + " - " + ex.getMessage()
